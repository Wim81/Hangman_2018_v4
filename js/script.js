$( document ).ready(function() {
    ...
    /* de bibliotheek! */
    var library = ["tetten", "eerlijk", "vibrator", "voorbinddildo", "excuus", "enkelband", "buttplug", "zoekertje", "tentsletje", "breezersletje", "orgasme", "culinair", "verrassing", "vertrouwen", "goedgelovig", "membraan", "utopie", "klikspaan", "anagram", "infuus", "conclusie", "wereldleider", "aanname", "ultimatum", "kin", "petje", "heisa", "trouwfeest", "mantel", "bonus", "sexy", "zeerover", "xylofoon", "piano", "muziek", "podium", "macht", "duif", "restaurant", "effectief", "neanderthaler", "typografie", "komedie", "gemakzucht", "spatel", "brandweer", "politie", "drugs", "tabak", "bier", "wijn", "alcohol", "festival", "computer", "toetsenbord", "beeldscherm", "kasteel", "moordwapen", "gevoelig", "metamorphose", "mandaat", "levendig", "luieren", "quasi", "koekoek"];
